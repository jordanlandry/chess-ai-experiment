...
use crate::{bitboard::{Bitboard, FILE_H, RANK_8, FILE_A, RANK_5, RANK_4, RANK_1}, minimax::make_move, print_bitboard }; 
...
pub fn get_white_moves(board: Bitboard, look_for_checks: bool) -> Vec<Move> {    
    ...
    for pos in rook_positions.iter() {
        let m = get_rook_moves_1(*pos as usize, true, white_pieces, black_pieces);
